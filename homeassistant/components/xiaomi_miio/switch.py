...
from .const import (
    ...
    FEATURE_FLAGS_AIRHUMIDIFIER_MJSSQ_AND_JSQS,
...
async def async_setup_coordinated_entry(hass, config_entry, async_add_entities):
    ...
    elif model in MODELS_HUMIDIFIER_MJJSQ + MODELS_HUMIDIFIER_JSQS:
        device_features = FEATURE_FLAGS_AIRHUMIDIFIER_MJSSQ_AND_JSQS
